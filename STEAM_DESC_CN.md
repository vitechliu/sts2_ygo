...
YGOMD 是一个仍在开发中的《杀戮尖塔 2》Mod，将游戏王·大师决斗的卡牌、额外卡组与召唤方式改造成适合尖塔战斗的卡组构筑玩法。


> 项目处于早期开发阶段、内测阶段，卡牌数值、资源、界面和存档格式仍可能调整。
> 
# 目前仅支持beta版！

| 人物              | 完成度 | 卡牌数量  | 备注       |
|-----------------|-----|-------|----------|
| 丸藤亮             | 95% | 66+15 | 缺少:专属事件等 |
| Playmaker(藤木游作) | 85% | 55    | 缺少:遗物、卡牌 |
...
完整更新内容见：[更新内容](https://github.com/vitechliu/sts2_ygo/blob/master/CHANGELOG.md)
