...
3. Search `D:/github/raw107/src/Core/Models/Relics/` for one or more original relics with the same trigger, state lifetime, or reward. Copy the lifecycle pattern and method signature, not the original balance or theme. Never modify that directory.
