...
internal static class ExtraDeckSummonAnimations {
    ...
    internal static async Task PlayXyzSummonAnimation(SummonAnimationContext context, bool reportFailure, bool slowMaterials = false) {
        ...
        try {
            await Card3DEffectUtil.RunMultipleCard3DEffect(
                visibleMaterials.Append(context.FinalCard),
                async (cards, _) => await xyzAnim2D.Manager.Play(cards, visibleMaterials.Count, slowMaterials),
                context.ScreenCenterPos,
